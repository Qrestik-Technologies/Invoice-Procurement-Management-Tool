...
import { toDisplaySync } from '../utils/status';
                ...
                <tbody className="divide-y divide-border">
                  {documents.map((doc) => (
                    <tr key={doc.id} className="hover:bg-gray-50/80">
                      ...
                      <td className="px-5 py-3"><button type="button" className="flex items-center gap-1 text-xs hover:text-primary"><Download className="h-4 w-4" />Download</button></td>
                    </tr>
                  ))}
                </tbody>
              </table>
